use tokio::sync::mpsc;
use std::sync::Arc;
use crate::models::{state::StreamEvent, error::SyncError};
...
pub async fn background_to_postgres(state: &Arc<AppState>, mut stream_rx: mpsc::Receiver<StreamEvent>) -> Result<(), SyncError> {
    tracing::info!("Start");
